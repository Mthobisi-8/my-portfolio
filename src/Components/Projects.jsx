...
const Projects = () => {
  ...
  const myprojects = [
    {
      ...
      message:
        'ThinkFriday is a project that was made at ForgeAcademy for Mr Tariq Shurmah company and below is the prototype we had created along side my collegue Nthabiseng Moyaba ,below you can view the project or get the actual code on my Github:https://github.com/Mthobisi-8',
    },
    {
      id: 2,
      ...
      message:
        'Rose cafeteria is a final project for work intergrated learning where we were creating a website for Rosebank College for their cafeteria so learners could learn and order from their smart phones and find their food freshly prepared rather than waiting in long lines to have your delicious food ,below you can view the project or get the actual code on my Github:https://github.com/Mthobisi-8',
    },
    {
      id: 3,
      title: 'Forge Talent',
  ...
  return (
    <div
      name="Projects"
      className="w-full min-h-screen bg-gradient-to-b from-gray-800 to-black text-white flex flex-col items-center justify-center py-12"
    >
      <div className="max-w-screen-lg mx-auto p-4">
        ...
        {/* Project Cards */}
        <div className="flex flex-wrap justify-center gap-8 mt-6 group">
          {myprojects.map(({ id, title, images }) => (
            <div
              ...
              className="
                ...
                w-48 h-48 cursor-pointer transition-all duration-500
            ...
            >
              <img
                src={images[0]}
                alt={title}
                className="h-24 w-36 mx-auto rounded-lg"
              />
          ...
          <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
            <div className="relative text-center max-w-4xl">
              <button
                ...
                className="absolute right-4 top-4 text-white bg-red-600 px-3 py-1 rounded-full hover:bg-red-700 transition"
              >
                ✕
              </button>
              ...
              {!showSlideshow ? (
                <div className="mt-10">
                  <p className="bg-gray-900 p-4 rounded-lg">
                    {selectedProjectData.message}
                  </p>
                  <button
                    onClick={() => setShowSlideshow(true)}
                    className="mt-4 px-4 py-2 bg-blue-600 hover:bg-blue-800 rounded-lg transition"
                  >
                    View Project
                  </button>
                </div>
                ...
                <div className="relative">
                  <img
                    ...
                    alt="Project Slide"
                    className="w-[700px] h-auto mx-auto mt-10 rounded-lg shadow-2xl"
                  />
                  <button
                    onClick={handlePrevClick}
                    className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-gray-600 hover:bg-gray-800 p-2 rounded-full"
                  >
                    <IoIosArrowBack />
                  </button>
                  <button
                    onClick={handleNextClick}
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-gray-600 hover:bg-gray-800 p-2 rounded-full"
                  >
                    <IoIosArrowForward />
                  </button>
                </div>
